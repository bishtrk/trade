#Loads your scrip.csv data.

#Computes “prior resistance” as the highest High over the last N days (shifted by one to exclude today).

#Flags breakout days where the current Close exceeds that resistance.

#Prints out the breakout dates with their Close and resistance levels.
